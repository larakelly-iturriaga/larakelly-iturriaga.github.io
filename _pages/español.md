...
| Título  | Evento | Fecha |
| -------------------------- | -------------------------- | ------------------: |
| _The role of language distance in bilingual language processing_ (Póster)  | [15 Simposio Internacional del Bilingüismo (ISB15)](https://www.bcbl.eu/events/isb15/en/), Basque Center on Cognition, Brain and Language, Donostia-San Sebastián  | 9-13 de junio de 2025  |
